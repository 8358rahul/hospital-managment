      ...
      <Box sx={{ px: 2, overflow: 'auto' }}>
        <List>
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={NavLink} to="/doctor" sx={navItemStyles} end>
          ...
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={NavLink} to="/doctor/appointments" sx={navItemStyles}>
          ...
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={NavLink} to="/doctor/patients" sx={navItemStyles}>
